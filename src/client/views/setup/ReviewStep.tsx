...
export function ReviewStep(props: {
  ...
  return (
    <>
      ...
      <p className="muted">
        Double-check these values before committing. You can't undo setup without resetting the
        database.
      </p>
      <dl className="review">
        <dt>Workspace</dt>
        ...
        <dt>Admin</dt>
        <dd>
          {admin.admin_name ? `${admin.admin_name} · ${admin.admin_email}` : admin.admin_email}
        </dd>
        <dt>Password</dt>
