...
const stripeRefundTools: ProcedureLibraryMcpToolSpec[] = [
  {
    server: 'stripe',
...
const identityTools: ProcedureLibraryMcpToolSpec[] = [
  {
    server: 'identity',
    tool: 'users.lookup',
...
const shopifyTools: ProcedureLibraryMcpToolSpec[] = [
  {
    server: 'shopify',
    tool: 'orders.search',
...
const privacyTools: ProcedureLibraryMcpToolSpec[] = [
  {
    server: 'privacy',
...
export const PROCEDURE_LIBRARY: ProcedureLibraryItem[] = [
  entry(
    refundIntake,
    'billing',
