...
import { auditMeta, type AuditActorType } from '../../types/audit';
...
/** Canonical serialization hashed into the chain. Order is fixed and must not change. */
function chainPayload(parts: (string | null)[]): string {
