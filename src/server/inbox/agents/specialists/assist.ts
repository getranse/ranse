import type { DraftAssistInput, SimilarTicket, DraftAssistResult } from '../../../../interfaces/agents';
export type { DraftAssistInput, SimilarTicket, DraftAssistResult };
import type { Env } from '../../../env';
import { searchKnowledge } from '../../../automation/knowledge';
import type { AgentConfig } from '../../../../types/server/llm';
import { infer } from '../../../../lib/llm/infer';
import { AssistResult, } from '../../../schemas/assist';
import { ASSIST_KB_HITS as KB_HITS, ASSIST_PAST_TICKETS as PAST_TICKETS } from '../../../../config/knowledge';
