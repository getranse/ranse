...
`procedure manifest` emits the full machine-readable catalog for mirroring into a standalone community repo. `procedure validate-library` reruns schema checks, inline evals, checksum generation, and MCP annotation checks.
